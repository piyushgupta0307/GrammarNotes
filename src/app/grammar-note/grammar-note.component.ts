...
export class GrammarNoteComponent {
  ...
  ngOnInit() {
    ...
    this.htmlPath = this.domSanitizer.bypassSecurityTrustResourceUrl(this.assestsPath + "images/image 78.png");
  }
  ...
  private playVideo(videoPat, inex) {
    ...
    this.htmlPath = this.domSanitizer.bypassSecurityTrustResourceUrl(this.videoPath);
    // this.playVideoAuto();
  }
